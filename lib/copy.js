...
export const copy = {
  metadata: {
    title: "Esencia Pro | 1000 Zdravých receptů 2.0",
    description:
  ...
  brand: {
    name: "Esencia Pro",
    tagline: "1000 Zdravých receptů 2.0",
  },
  ...
  benefits: {
    ...
    forYouItems: [
      ...
      },
      {
        ...
        desc: "Jídla, na kterých si pošmákne celá domácnost, nejen člověk s diabetem.",
      },
    ],
    ...
    items: [
      {
        ...
        tag: "BONUS 1",
        title: "E-kniha: 15 Zdravých polévek",
        desc: "Obsahuje 15 parádních receptů na teplé polévky s nízkým obsahem sacharidů a cukrů.",
        value: "390 Kč",
      },
      {
        image: "/bonuses/batidos.webp",
        tag: "BONUS 2",
        title: "E-kniha: 10 Zdravých smoothie",
        desc: "10 receptů na osvěžující smoothie bez zbytečných cukrů.",
        value: "390 Kč",
      },
      {
        image: "/bonuses/snacks.webp",
        tag: "BONUS 3",
        title: "E-kniha: 15 Zdravých svačinek",
        desc: "15 nápadů na rychlé a zdravé odpolední zakousnutí pro lidi s diabetem.",
        value: "390 Kč",
      },
      {
  ...
  finalCta: {
    ...
    urgencyTop: "SLEVA 80 %",
    headline:
      "ZÍSKEJTE NAŠI E-KNIHU JEŠTĚ DNES S BRUTÁLNÍ SLEVOU!",
    subUrgency:
    ...
    bundleList: [
      ...
      "Bonus 1 — 15 Zdravých polévek",
      "Bonus 2 — 10 Zdravých smoothie",
      "Bonus 3 — 15 Zdravých svačinek",
    ...
    urgencyText: "PLATBA SE PŘEPOČÍTÁ A PROBĚHNE VE VAŠÍ LOKÁLNÍ MĚNĚ",
  ...
  faq: {
    authorRole: "Esencia Pro · Tým pro zdravou výživu",
    authorHeadline: "Skvělé jídlo, které aktivně pečuje o vaše zdraví",
    authorBio:
      "V Esencia Pro věříme, že by vás cukrovka neměla připravit o to nejlepší – potěšení z jídla. Každý náš recept je vyladěný tak, abyste si mohli pochutnávat bez výčitek a zároveň měli svou glukózu plně pod kontrolou.",
    authorImageAlt: "Tým Esencia Pro",
    ...
    items: [
      ...
      {
        q: "Můžu platit ve své měně?",
        a: "Ano. Během nákupu se vám na pokladně platba automaticky přepočítá a zobrazí přesně ve vaší lokální měně.",
      },
    ],
  },
  ...
  footer: {
    brand: "PRO ESCALA",
    copyright: "Copyright © proescala.online ® 2026",
    disclaimer:
